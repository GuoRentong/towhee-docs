...
<KatacodaBlock>
  pip3.7 install -i https://test.pypi.org/simple/ --extra-index-url
  https://pypi.org/simple towhee==0.3.1.dev19
</KatacodaBlock>
...
<KatacodaBlock>
  wget
  https://github.com/towhee-io/towhee-docs/raw/main/docs/get-started/logo.png
</KatacodaBlock>
